//
//  CCExihibitioningTableViewCell.m
//  xiangcun
//
//  Created by 李孝帅 on 16/11/3.
...
@interface CCExihibitioningTableViewCell ()
{
...
@implementation CCExihibitioningTableViewCell
...
-(void)setModel:(CCNowExihibitionModel *)model{
    if (_model!=model) {
        _model=model;
