//
//  CCHistroyTableViewCell.m
//  xiangcun
//
//  Created by 李孝帅 on 16/9/24.
...
@interface CCHistroyTableViewCell ()
...
@implementation CCHistroyTableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self=[super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
       ...
       // _leftImage.image=[UIImage imageNamed:@"hhh"];
...
-(void)setModel:(CCHistoryExihibitionModel *)model{
    if (_model!=model) {
        _model=model;
