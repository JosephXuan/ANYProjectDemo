...
@interface CCPlantMoreViewController ()< UITableViewDataSource,UITableViewDelegate>
{
...
@implementation CCPlantMoreViewController
...
- (void)viewDidLoad {
    ...
    self.title=[NSString stringWithFormat:@"%@-更多",_name];
...
-(void)setBaseView{
    ...
    _secondTableView=[[UITableView alloc]initWithFrame:CGRectMake(5.0/360.0*ScreenWidth, 0.0, ScreenWidth-10.0/360.0*ScreenWidth, ScreenHeight-109.0/667.0*ScreenHeight)];
...
-(void)requsetData{
    ...
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"article.category.list", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" : @"1",@"categoryId":[NSString stringWithFormat:@"%@",_ids]}];
...
- (void)loadMoreData {
    ...
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"article.category.list", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"categoryId":[NSString stringWithFormat:@"%@",_ids],@"pageNo" : [NSString stringWithFormat:@"%zd",_curPage]}];
    [manager GET:URL.absoluteString parameters:parameters success:^(NSURLSessionTask *task, id responseObject) {
        _curPage ++;
        NSArray *article = responseObject[@"article"];
...
-(void)setController:(id)responseObject{
    ...
    _secListWebViewController.title=@"种植";
