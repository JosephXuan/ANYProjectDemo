...
#import "MJRefresh.h"
@interface CCAllSearch ()< UITableViewDataSource,UITableViewDelegate>
{
...
//------自定义控件-------
    NSDictionary *dic=[[NSUserDefaults standardUserDefaults]objectForKey:@"searchword"];
...
-(void)requsetData{
    ...
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"article.search", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" : @"1", @"searchword" : [NSString stringWithFormat:@"%@",_searchWord]}];
...
- (void)loadMoreData {
    ...
    manager.responseSerializer =[AFJSONResponseSerializer serializer];
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"text/plain", @"application/json", @"text/json", @"text/html",@"application/xml" ,nil];
     NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"article.search", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" : [NSString stringWithFormat:@"%zd",_curPage], @"searchword" : [NSString stringWithFormat:@"%@",_searchWord]}];
...
-(void)setController:(id)responseObject{
    ...
    _secListWebViewController.title=@"新动向";
