...
#import "MJRefresh.h"
@interface CCJingDianSearch  ()< UITableViewDataSource,UITableViewDelegate>
{
...
@implementation CCJingDianSearch
...
//------自定义控件-------
    NSDictionary *dic=[[NSUserDefaults standardUserDefaults]objectForKey:@"jingDian"];
...
-(void)requsetData{
    ...
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"query.farmTour.spots",@"areaId": [NSString stringWithFormat:@"%@",_areaID], @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" : @"1", @"keyword" : [NSString stringWithFormat:@"%@",_searchWord]}];
    NSLog(@"景点输入内容是%@",_searchWord);
    [manager GET:URL.absoluteString parameters:parameters success:^(NSURLSessionTask *task, id responseObject) {
       ...
       // NSLog(@"景点搜索在线解析＝%@",responseObject);
        // NSLog(@"_areaID2222===%@",_areaID);
...
- (void)loadMoreData {
    ...
    manager.responseSerializer =[AFJSONResponseSerializer serializer];
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"text/plain", @"application/json", @"text/json", @"text/html",@"application/xml" ,nil];
   NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"query.farmTour.spots",@"areaId": [NSString stringWithFormat:@"%@",_areaID], @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" :[NSString stringWithFormat:@"%zd",_curPage], @"keyword" : [NSString stringWithFormat:@"%@",_searchWord]}];
    [manager GET:URL.absoluteString parameters:parameters success:^(NSURLSessionTask *task, id responseObject) {
        _curPage ++;
        NSArray *article = responseObject[@"article"];
...
-(void)setController:(id)responseObject{
    ...
    _secListWebViewController.title=@"景点搜索";
