...
-(void)loadNewData{
    ...
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"member.history.list", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" : @"1",@"sessionId" : [NSString stringWithFormat:@"%@",_sessID]}];
...
- (void)loadMoreData {
    ...
    manager.responseSerializer =[AFJSONResponseSerializer serializer];
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"text/plain", @"application/json", @"text/json", @"text/html",@"application/xml" ,nil];
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"member.history.list", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json", @"pageNo" :[NSString stringWithFormat:@"%zd",_curPage],@"sessionId" : [NSString stringWithFormat:@"%@",_sessID]}];
...
-(void)setController:(id)responseObject{
    ...
    _secListWebViewController.title=@"历史记录";
...
-(void)deleteRequest{
    ...
    NSMutableDictionary *parameters = [NSMutableDictionary dictionaryWithDictionary:@{@"method" : @"member.history.del", @"appKey" : @"w4q897jgvxkb", @"v" : @"1.0", @"format" : @"json",@"id": [NSString stringWithFormat:@"%@",_secondmodel.ids],@"sessionId": [NSString stringWithFormat:@"%@",str1]}];
    [manager GET:URL.absoluteString parameters:parameters success:^(NSURLSessionTask *task, id responseObject) {
